...
After cloning/downloading the repository, simply install Kubernetes-Servcice-Selection as a package into your target virtual environment:

    $ pip install PATH_TO_kubernetes_servcice_selection
...
changes to the source code take immediate effect on the installed package.
    ...
    $ pip install -e PATH_TO_kubernetes_servcice_selection
