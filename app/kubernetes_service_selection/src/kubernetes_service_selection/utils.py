...
cache = {}
BASE_DIR_ENV_VAR = "/Users/danielbachar/Documents/Kube-Load-Balancing/app/kubernetes_service_selection/dataframes"
...
def get_load_df(app_name):
    global BASE_DIR_ENV_VAR
    return pd.read_csv("{}/load/{}.csv".format(BASE_DIR_ENV_VAR, app_name), index_col=False)
