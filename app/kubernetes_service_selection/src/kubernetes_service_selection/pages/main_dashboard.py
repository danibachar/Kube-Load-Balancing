...
from ..graphs.load_by_time_of_day import app_load_graph, total_load_global
...
@app.callback(
    Output('service-to-service-load', 'figure'),
    [
        Input("balance-option", "value"),
        Input("app-option", "value"),
    ])
def services_to_service_load_callback(balance_option, app_option):
    return app_load_graph(app_option, balance_option)

@app.callback(
    Output('global-load', 'figure'),
    [
        Input("balance-option", "value"),
        Input("app-option", "value"),
    ])
def total_load_global_callback(balance_option, app_option):
    return total_load_global(app_option, balance_option)
